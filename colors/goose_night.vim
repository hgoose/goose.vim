...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#ca1243', '#2a871f', '#c18401',
        \ '#2f6aea', '#a626a4', '#0184bc', '#1a1b26', '#808080', '#ca1243',
  ...
  if get(g:, 'goose_night_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#000000 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#ffffff guibg=#1a1b26 gui=NONE cterm=NONE
  endif
  ...
  " hi VertSplit guifg=#1a1b26 guibg=#ff00ff gui=NONE cterm=NONE
  hi VertSplit guifg=#f0f0f0 guibg=#1a1b26 gui=NONE cterm=NONE
  hi Pmenu guifg=NONE guibg=#1a1b26 gui=NONE cterm=NONE
  hi PmenuSel guifg=#ffffff guibg=#1a1b26 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#1a1b26 gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#1a1b26 gui=NONE cterm=NONE
  ...
  hi NonText guifg=#1a1b26 guibg=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#1a1b26 guibg=NONE gui=NONE cterm=NONE
