...
hi clear
let g:colors_name = 'goose_purpv2'
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#ca1243', '#2a871f', '#c18401',
        \ '#2f6aea', '#a626a4', '#0184bc', '#1b002e', '#808080', '#ca1243',
  ...
  if get(g:, 'goose_purpv2_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#000000 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#ffffff guibg=#1b002e gui=NONE cterm=NONE
  endif
  hi EndOfBuffer guifg=#1b002e guibg=NONE gui=NONE cterm=NONE
  ...
  " hi VertSplit guifg=#1b002e guibg=#ff00ff gui=NONE cterm=NONE
  hi VertSplit guifg=#f0f0f0 guibg=#1b002e gui=NONE cterm=NONE
  hi Pmenu guifg=NONE guibg=#1b002e gui=NONE cterm=NONE
  hi PmenuSel guifg=#ffffff guibg=#1b002e gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#1b002e gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#1b002e gui=NONE cterm=NONE
  ...
  hi NonText guifg=#1b002e guibg=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#1b002e guibg=NONE gui=NONE cterm=NONE
